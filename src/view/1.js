...
function createOffersTemplate(offers = [], selectedOffers = []) {
  return offers.map((offer) => createOfferTemplate(offer, selectedOffers)).join('');
}
...
function createTypesTemplate(types = [], currentType) {
  return types.map((type) => createTypeTemplate(type, currentType)).join('');
}
...
function createEditPointTemplate(point = {}, destination = null, destinations = [], types = [], offers = []) {
  const {
    id = '',
    type = '',
          ...
          <div class="event__type-wrapper">
            ...
            <div class="event__type-list">
              <fieldset class="event__type-group">
                ...
                ${createTypesTemplate(types, type)}
              </fieldset>
            </div>
          </div>
              ...
              ${destinationPictures.length ? `
                <div class="event__photos-container">
                  <div class="event__photos-tape">
                    ${createPicturesTemplate(destinationPictures)}
                  </div>
                </div>
              ` : ''}
            </section>
...
export default class EditPointView {
  constructor(point, destination, destinations, types, offers) {
    this.point = point;
